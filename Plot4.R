...
ElectricPowerConsumption[,Voltage:=as.numeric(Voltage)]
ElectricPowerConsumption[,Global_reactive_power:=as.numeric(Global_reactive_power)]
...
# Plot2
plot(ElectricPowerConsumption[,timeofWeekMinuts], ElectricPowerConsumption[,Voltage]
     ,type="l"
     ,ylab="Voltage"
     ,xlab="datetime"
     ,xaxt="n"
...
# Plot4
plot(ElectricPowerConsumption[,timeofWeekMinuts], ElectricPowerConsumption[,Global_reactive_power]
     ,type="l"
